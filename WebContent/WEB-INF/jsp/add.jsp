...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <br>
		<div class="ui input">
		<form class="ui large form" action="addStudent" method="post" >
        <div class="field">
          <div class="ui left icon input">
           <span class=" m-padded-tiny m-line">学 号</span><input type="text" name="number" placeholder="添加学号" >
          </div>
        </div>
        <div class="field">
          <div class="ui left icon input">
           <span class=" m-padded-tiny m-line">姓 名</span>	<input type="text" name="name" placeholder="添加姓名" >
          </div>
        </div>
         <div class="field">
          <div class="ui left icon input">
         
            <span class=" m-padded-tiny m-line">入学时间</span><input type="text"  name="time" placeholder="添加入学时间" 	>
          </div>
        </div>
         <div class="field">
          <div class="ui left icon input">
         
            <span class=" m-padded-tiny m-line">班级</span><input type="text" name="classnumber" placeholder="添加班级" 	  >
          </div>
        </div>
         <div class="field">
          <div class="ui left icon input">
         
            <span class=" m-padded-tiny m-line">身份证</span><input type="text" name="identity" placeholder="添加身份证" 	 >
          </div>
        </div>
        <div class="field">
          <div class="ui left icon input">
         
            <span class=" m-padded-tiny m-line">政治面貌</span><input type="text" name="politic" placeholder="添加政治面貌" 	 >
            
          </div>
        </div>
        <div class="field">
          <div class="ui left icon input">
           <span class=" m-padded-tiny m-line">数 学</span><input type="text" name="math" placeholder="添加成绩数学" >
          </div>
        </div>
        <div class="field">
          <div class="ui left icon input">
           <span class=" m-padded-tiny m-line">英 语</span>	<input type="text" name="english" placeholder="添加英语成绩" >
          </div>
        </div>
         <div class="field">
          <div class="ui left icon input">
         
            <span class=" m-padded-tiny m-line">计算机</span><input type="text" name="computer" placeholder="添加计算机成绩" >
          </div>
        </div>
        <button  class="ui inverted green fluid  submit button">确 认 添 加</button>
      </div>
	</form>
		</div>
